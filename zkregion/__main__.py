...
def main() -> int:
    ...
    bccbr_binding = bccbr.bind_once(chain_bound, chain_bound_root, b"bound-chain-session-1", expires_at=10**12)
    ...
    other_bccbr_binding = other_bccbr.bind_once(chain_bound, chain_bound_root, b"bound-chain-session-2")
    print(f"  wrong root rejected without consuming the id: "
    ...
    foreign_bccbr_binding = foreign_bccbr.bind_once(chain_bound, chain_bound_root, b"bound-chain-session-3")
    print(f"  binding from another guard instance rejected: "
